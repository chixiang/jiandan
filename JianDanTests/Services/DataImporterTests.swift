...
final class DataImporterTests: XCTestCase {
    ...
    private var sampleJSONData: Data {
        let json = """
        {
          "version": 1,
          "records": [
            {"name": "蓝色羊毛大衣", "category": "衣物", "farewellDate": "2026-01-15", "method": "捐赠", "purchaseDate": "2024-11-20", "purchasePrice": 1280, "emotionValue": 3, "recipientDetail": "回收箱", "farewellLetter": "暖意还在", "photoFilenames": []},
            {"name": "旧小说全集", "category": "书籍", "farewellDate": "2025-12-28", "method": "送人", "purchaseDate": "2019-09-01", "purchasePrice": 320, "emotionValue": 2, "recipientDetail": "图书馆", "farewellLetter": "去陪下一个人了", "photoFilenames": []},
            ...
            {"name": "旧明信片一箱", "category": "杂物", "farewellDate": "2026-06-20", "method": "扔掉", "emotionValue": 2, "farewellLetter": "每一张都是一段路", "photoFilenames": []},
            ...
            {"name": "陶瓷杯", "category": "其他", "farewellDate": "2026-02-14", "method": "其他", "purchaseDate": "2023-09-01", "emotionValue": 3, "recipientDetail": "碎了", "farewellLetter": "使命已尽", "photoFilenames": []},
